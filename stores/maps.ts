...
import { useRoadsService } from "~/services/roads"; // Путь может отличаться

// Типы для GeoJSON (можно вынести в отдельный types.d.ts файл)
...
export const useMapsStore = defineStore("maps", () => {
  ...
  function snapPointToRoad(rawLatLng: L.LatLng): L.LatLng | null {
    return _snapToNearestRoadVertex(rawLatLng, roadsData.value);
  }
